...
if (isset($_POST['pay_now'])) {
    ...
    $query2 = "INSERT INTO `booking details`(`booking_id`, `room_name`, `price`, `total_pay`, `user_name`, `phonenum`, `address`) VALUES (?,?,?,?,?,?,?)";
...
<!-- remove post method from confirm_booking.php line:98 you will be able to see the payment getewat  -->